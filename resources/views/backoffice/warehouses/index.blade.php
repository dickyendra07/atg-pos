...
<head>
    ...
    <title>Warehouses - Back Office ATG POS</title>
    <style>
        body {
            margin: 0;
...
<body>
    <div class="wrap">
        <div class="topbar">
            <div>
                <div class="title">Back Office - Warehouses</div>
                <div class="subtitle">
                    Halaman ini dipakai untuk mengelola daftar warehouse aktif sebagai lokasi gudang utama di sistem. Data warehouse di sini akan dipakai untuk inventory control, stock movement, transfer antar lokasi, dan referensi opening stock import.
                </div>
            </div>
