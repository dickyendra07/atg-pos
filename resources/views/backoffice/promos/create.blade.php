                    ...
                    <div class="form-grid">
                        ...
                        <div class="field">
                            ...
                            <select name="requirement_logic" id="requirement_logic" required>
                                <option value="and" @selected(old('requirement_logic', 'and') === 'and')>AND - Semua requirement wajib terpenuhi</option>
                                <option value="or" @selected(old('requirement_logic') === 'or')>OR - Salah satu requirement cukup terpenuhi</option>
                            </select>
                        </div>
