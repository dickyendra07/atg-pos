...
@php
    $pageTitle = 'Create Discount - Back Office ATG POS';
@endphp
...
@section('content')
    ...
    <div class="page-shell">
        <div class="topbar">
            <div>
                <div class="kicker">Create Discount</div>
                <h1 class="page-title">Create Discount</h1>
                <p class="page-subtitle">
                    Buat master discount dari Backoffice. Discount ini nantinya bisa dipilih di Cashier saat checkout.
                </p>
            </div>
            ...
            <form method="POST" action="{{ route('backoffice.discounts.store') }}">
                ...
                <div class="form-grid">
                    <div class="field full">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Contoh: VIP 10%, Voucher Rp 20.000" required>
                        @error('name')
                    ...
                    <div class="field">
                        ...
                        <select name="type" id="type" required>
                            <option value="amount" @selected(old('type', 'amount') === 'amount')>Nominal Rp</option>
                    ...
                    <div class="field">
                        ...
                        <input type="number" name="value" id="value" value="{{ old('value') }}" min="0" step="0.01" placeholder="Contoh: 20000 atau 10" required>
