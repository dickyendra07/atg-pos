...
<head>
    ...
    <title>Import Variants - Back Office ATG POS</title>
    <style>
        body {
            margin: 0;
...
<body>
    <div class="wrap">
        ...
        <div class="card">
            <div class="info">
                Upload file CSV sesuai template. Product harus sudah ada dulu di sistem.
            </div>

            <form method="POST" action="{{ route('backoffice.variants.import.store') }}" enctype="multipart/form-data">
                @csrf
