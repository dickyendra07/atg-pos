...
@php
    $pageTitle = 'Tambah Variant - Back Office ATG POS';
@endphp
    ...
    <div class="variant-form-shell">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="note">
                    Gunakan kode singkat seperti <strong>R</strong>, <strong>L</strong>, <strong>XL</strong>. Nama tetap bisa tampil lebih jelas seperti <strong>Regular</strong> atau <strong>Large</strong>.
                </div>
            </div>
        </div>
    </div>
